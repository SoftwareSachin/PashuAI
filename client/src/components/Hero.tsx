    ...
    <section className="relative bg-card border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="text-center max-w-4xl mx-auto">
          <Badge variant="secondary" className="mb-6" data-testid="badge-farmers">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Link href="/chat">
              <Button size="lg" variant="default" className="w-full sm:w-auto" data-testid="button-hero-launch">
                Launch Copilot
              </Button>
            </Link>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary mb-1" data-testid="stat-topics">
                4000+
              </div>
              <div className="text-sm text-muted-foreground">Topics Covered</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary mb-1" data-testid="stat-accuracy">
                95%
              </div>
              <div className="text-sm text-muted-foreground">Accuracy Rate</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary mb-1" data-testid="stat-languages">
                20+
              </div>
